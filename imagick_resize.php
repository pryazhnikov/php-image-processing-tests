...
$output_file = TestSettings::getOutputDir() . "imagick.jpg";
...
for ($i = 0; $i < TestSettings::NUM_RUNS; $i++) {
    ...
    $Image1->resizeImage($new_width, $new_height, \Imagick::FILTER_POINT, 1);
    $timers['resize'] += (microtime(true) - $time_scale_start);
